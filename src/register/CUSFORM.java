...
public class CUSFORM extends javax.swing.JFrame {
    ...
    public boolean duplicateCheck(){
        ...
        try{
            String query = "SELECT * FROM tbl_cus  WHERE u_username = '" + us.getText() + "' OR u_email = '" + mail.getText() + "'";
    ...
    private void initComponents() {
        ...
        ut.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Customer" }));
        ...
        jLabel1.setText("REGISTRATION FORM FOR CUSTOMER");
        jPanel4.add(jLabel1);

        jPanel3.add(jPanel4);
        jPanel4.setBounds(0, 40, 360, 32);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
      ...
      if (dbc.insertData("INSERT INTO tbl_cus (u_fname, u_lname, u_email,u_place , u_username, u_password, u_type, u_status,u_image) VALUES('"
