...
public class CUSLOGIN extends javax.swing.JFrame {
    ...
    public static boolean loginAcc(String username, String password){
        ...
        try{
            String query = "SELECT * FROM tbl_cus  WHERE u_username = '" + username + "'";
    ...
    private void initComponents() {
        ...
        jPanel2.add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 60, 210, 50));
        ...
        jPanel2.add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 120, 210, 50));
