 ...
 * @author User
 */
public class sche extends javax.swing.JFrame {
...
+"VALUES('"+fn.getText()+"','"+ln.getText()+"','"+nb.getText()+"','"+pl.getText()+"','"+dt.getText()+"','"+tt.getText()+"','"+ut.getSelectedItem()+"')"))
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(sche.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
